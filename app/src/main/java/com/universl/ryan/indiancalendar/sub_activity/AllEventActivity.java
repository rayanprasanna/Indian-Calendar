...
public class AllEventActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener{
    RelativeLayout main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(Html.fromHtml("<font color='#ffffff'>शीर्ष घटना</font>"));
    ...
    private void popupWindow(){
        final Dialog dialogs = new Dialog(AllEventActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home){
            Intent intent = new Intent(AllEventActivity.this, MainActivity.class);
        ...
        if (id == R.id.reminder){
            Intent intent = new Intent(AllEventActivity.this, RemindTaskActivity.class);
            startActivity(intent);
            finish();
        }
        if (id == R.id.all_holiday){
            Intent intent = new Intent(AllEventActivity.this, AllHolidayActivity.class);
            startActivity(intent);
            finish();
        }
        if (id == R.id.all_event){
            Intent intent = new Intent(AllEventActivity.this, AllEventActivity.class);
            startActivity(intent);
            finish();
        }
